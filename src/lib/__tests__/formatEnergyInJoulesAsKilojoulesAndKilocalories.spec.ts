...
describe('formatEnergyInJoulesAsKilojoulesAndKilocalories', () => {
  ...
  it('keeps precise kilojoules with up to three decimal places', () =>
    expect(formatEnergyInJoulesAsKilojoulesAndKilocalories(256800)).toBe('256,8 kJ (61 kcal)'))
  it('rounds kcal to the nearest whole number', () =>
    expect(formatEnergyInJoulesAsKilojoulesAndKilocalories(418400)).toBe('418,4 kJ (100 kcal)'))
